...
async def update_user_profile(
    ...
    """
    Update user profile information. Users can only update their own profiles.
    """
    ...
    updated_user = await UserService.update_profile(db, user_id, user_data, email_service)
